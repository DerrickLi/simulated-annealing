...
def solve(num_variables, num_constraints, solution, constraints, output_file):
    ...
    while unsatisfied > 0 and repeat_count < max_repeats:
        solution, unsatisfied = anneal(solution, num_constraints, constraints, output_file)
        repeat_count += 1
...
def neighbor(solution):
    ...
    # store the 2 wizards to swap
    # wizard1 = solution[random_num_list[0]]
    # wizard2 = solution[random_num_list[1]]
    # #swap the wizards
    # solution_copy[random_num_list[1]] = wizard1
    # solution_copy[random_num_list[0]] = wizard2
